...
su zotonic -c "/usr/local/bin/zotonic_config.awk -v defaults=true /home/zotonic/.zotonic/0.12/zotonic.config > $TMPFILE"
su zotonic -c "cat $TMPFILE > /home/zotonic/.zotonic/0.12/zotonic.config && rm $TMPFILE"
